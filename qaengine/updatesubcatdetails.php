...
<span itemprop="name"><h2><a href="updatesubcatdetails.php">Update SubCategory</a></h2></span></div>
...
$conn=mysqli_connect(host,uname,pass,dbname) or die("Error in connection" . mysqli_connect_error());
	...
	$q="select * from addsubcat where subcatid='$scatid'";
...
{
	$cid=$_POST["cat"];
	$scname=$_POST["subcategoryname"];
	if(isset($_FILES["subcatpic"])){
		$date = date_create();
	...
	$q="update addsubcat set catid='$cid',subcategoryname='$scname',subcategorypic='$scpic'where subcatid='$scatid'";
...
<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
      <table width="400" border="0" cellspacing="0" cellpadding="5">
        ...
        <tr height="50">
          <td><strong><font color="#000000">Choose Category</font></strong></td>
	...
	else
	{
        ...
        <tr height="35">
          <td><strong><font color="#000000">Sub Category Name</font></strong></td>
          <td><label for="subcategoryname"></label>
<input type="text" name="subcategoryname" id="subcategoryname"
			value="<?php print $y[2]; ?>" /></td>
        </tr>
        <tr height="120">
          <td><strong><font color="#000000">Sub Category Picture</font></strong></td>
          <td><p><?php

		  print "<img src='Uploads/$y[3]' height='50'>";

		  ?></p>
            <p>Choose new image, if required<br/>
