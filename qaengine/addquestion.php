...
<span itemprop="name"><h2><a href="addcat.php">Add Question</a></h2></span></div>
...
if(isset($_POST["submit"]) && isset($_POST["viewsubcat"]) &&isset($_POST["subcatid"]))
{
   $cid=$_POST["catid"];
   $scid=$_POST["subcatid"];
   $ques=$_POST["question"];
...
?>
<form name="form1"  id="subcatform" class="form_modal_style" method="post" enctype="multipart/form-data">
...
<label for="question">
Add Question </label>
<textarea name="question" cols="40" rows="7" class="name_user" id="question"></textarea><br/>
<font color="#FF0000"><b>
<?php
if(isset($msg))
print $msg;
