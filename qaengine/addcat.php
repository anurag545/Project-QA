...
<span itemprop="name"><h2><a href="addcat.php">Add Category</a></h2></span></div>
...
if(isset($_POST["submit"])&&isset($_POST["catname"]))
{
  ...
  if($err==0)
  {
   ...
   $conn=mysqli_connect(host,uname,pass,dbname) or die ("Error in connection". mysqli_connect_error());
	...
	{
		$msg="Problem in adding ,Plz try again";
    }
}
?>
<script>
...
<form name="form1"  id="catform" class="form_modal_style" method="post" enctype="multipart/form-data" onSubmit="return xyz()">

<label for="categoryname">
Category Name </label>
<input type="text" class="name_user" name="catname" id="username"/>
<label for="categorypic">
Category Pic</label>
