...
<span itemprop="name"><h2><a href="updatequestiondetails.php">Update Question</a></h2></span></div>
...
$conn=mysqli_connect(host,uname,pass,dbname) or die("Error in connection" . mysqli_connect_error());
	...
	$q="select * from addquestion where questionid='$quid'";
...
if(isset($_POST["submit"]))
{
	...
	$q="update addquestion set catid='$cid',subcatid='$scid',question='$uqid' where questionid='$quid'";
...
<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
	...
	else
	{
        ...
        <tr height="35">
          <td><strong><font color="#000000">Choose SubCat</font></strong></td>
	...
	else
	{
        ...
        <tr height="120">
          <td><label for="question"><font color="#000000">Question</font></label>
          </td><td>
<textarea name="ques" cols="40" rows="7" id="ques" type="text"
			value="<?php print $y[3]; ?>" /><?php print $y[3]; ?></textarea></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
