...
<span itemprop="name"><a href="#"><h2>Sub Categories</h2></a></span>
</div>
...
require_once("vars.php");
	...
	{
		print "<table width='750px' align='center' cellpadding='10' cellspacing='0'>";
		$count=0;
		while($x=mysqli_fetch_array($res))
		{
			...
			print "
			<td>
			<a href='question.php?scid=$x[0]'>
				<img src='Uploads/$x[3]' height='125'>
			</a>
			<h4><a href='question.php?scid=$x[0]'>$x[2]</a></h4>
			</td>";
			$count++;
			if($count==3)
			{
