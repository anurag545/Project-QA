...
<span itemprop="name"><h2><a href="updatecat.php">List Of Categories</a></h2></span></div>
...
require_once("vars.php");
	...
	{
	print "<table align='center' width='400' cellpadding='5px'  cellspacing='0'>
	<tr bgcolor='#2f364a' height='40'>
	<font color='#F4F4F4'>
	<td><h4><font color='#F4F4F4'>Picture</font></h4></td>
	<td><h4><font color='#F4F4F4'>Category</font></h4></td>
	<td><h4><font color='#F4F4F4'>Update</font></h4></td>
	<td><h4><font color='#F4F4F4'>Delete</font></h4></td>
	</font></tr>";
	while($x=mysqli_fetch_array($res))
	{
		print "<tr>
		<td height='61'><img src='Uploads/$x[2]' height='50'></td>
		<td>$x[1]</td>
		<td><a href='updatecatdetails.php?cid=$x[0]'>Update</a></td>
		<td><a href='deletecat.php?cid=$x[0]'>Delete</a></td>
		</tr>";
	}
	print "</table>";
	}
