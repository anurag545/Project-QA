...
Latest </a></li>
<li>
<a class="active" href="unanswered.php">
Unanswered </a></li>
</ul> 
</div>
...
<ul>
<li>
<a class="" href="indexuser.php">
Latest </a>
</li>
<li><a class="active" href="unanswered.php">
Unanswered </a></li>
<li></li>
</ul>
</div>
...
require_once("vars.php");
	...
	$q2="select addquestion.questionid,addquestion.question,addquestion.questiondate, answer.questionid from addquestion,answer where addquestion.questionid!=answer.questionid order by addquestion.questiondate desc limit 15";
...
<h1 itemprop='name'>
<a itemprop='url' href='answer.php?qid=$x[0]' class='question-title'>$x[1]</a>
</h1>
</div></font>
...
<span class='mask-poll'><a href='answer.php?qid=$x[0]'>Your Answer</a></span>
</div>
</div> 
