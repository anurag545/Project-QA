...
<span itemprop="name"><h2><a href="updatecatdetails.php">Update Category</a></h2></span></div>
...
{
   $cname=$_POST["catname"];
  if(isset($_FILES["catpic"]))
  {
	  $date=date_create();
	  $tstamp=date_timestamp_get($date);
	  $cpic=$tstamp.$_FILES["catpic"]["name"];
   ...
   $conn=mysqli_connect(host,uname,pass,dbname) or die ("Error in connection". mysqli_connect_error());
	$q="update addcat set categoryname='$cname',categorypic='$cpic' where catid='$catid' ";
	...
	{
		$msg="Problem in updating ,Plz try again";
    }
}
?>
<?php
...
<form method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table width="500" border="0" cellpadding="5" cellspacing="0">
      <tr valign="middle">
      <td width=""><font color="#000000">Category Name</font></td>
      <td><input type="text" name="catname" id="catname" value="<?php
      print $x[1];
	  ?>"/></td>
    </tr>
    <tr valign="middle" height="150">
      <td><font color="#000000">Category Pic</font></td>
      <td><?php
	  print "<img src='Uploads/$x[2]' height='60'>";
	  ?></br>
    ...
    <tr>
      <td>&nbsp;</td>
      <td><input name="submit" type="submit" id="submit" value="Update Category" />
