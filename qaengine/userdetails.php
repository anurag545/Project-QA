...
<span itemprop="name"><h2><a href="userdetails.php">User Details</a></h2></span></div>
...
?>
<form name="form1"  id="search" class="form_modal_style" method="post">
<label for="email">
User Email </label>
<input name="search" type="text" class="name_user" id="question" size="40">
<br/>
<font color="#FF0000"><b>
<?php
if(isset($msg))
print $msg;
?></b></font>
<input type="submit" name="submit" value="Details" class="btn-submit"><br/><br/><br/>
</form>
  <?php
       if(isset($y))
	   {
	   print "<table cellpadding='5px' cellspacing='5' width='300' height='200'>
	    <tr>
	   <th>Profile Pic :</th>
	   <th><img src='Uploads/$y[Profile]' height='75'></th>
	   </tr>
	   <tr>
	   <th>Name :</th>
	   <th>$y[Name]</th>
