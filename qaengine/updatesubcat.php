...
<span itemprop="name"><h2><a href="updatesubcat.php">List Of SubCategories</a></h2></span></div>
	...
	$res=mysqli_query($conn,$q) or die("Error in query" . mysqli_error($conn));
			...
			else
			{
				...
				<tr align='left' bgcolor='#2f364a' height='35'>
					<th><h4><font color='#F4F4F4'>Sub Cat Picture</font></h4></th>
					<th><h4><font color='#F4F4F4'>Sub Cat Name</font></h4></th>
				...
				{
					print "<tr height='70'>
					<td><img src='Uploads/$x[3]' height='60'></td>
					<td>$x[2]</td>
		<td><a href='updatesubcatdetails.php?scid=$x[0]'>Update</a></td>
					<td><a href='deletesubcat.php?scid=$x[0]'>Delete</a></td>
					</tr>";
				}
				print "</table>";
			}
