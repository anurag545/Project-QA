...
<span itemprop="name"><h2>Welcome  <a href=""><?php
	if(isset($_SESSION["n"]))
	{
	 print $_SESSION["n"];
	}
...
?>
<ul>
<li><a href="addcat.php" class="admin"><b>Add Category</b></a><br/></li>
<li><a href="addsubcat.php" class="admin"><b>Add SubCategory</b></a><br/></li>
<li><a href="addquestion.php" class="admin"><b>Add Questions</b></a><br/></li>
<li><a href="updatecat.php" class="admin"><b>Update/Delete Cat</b></a><br/></li>
<li><a href="updatesubcat.php" class="admin"><b>Update/Delete SubCat</b></a><br/></li>
<li><a href="updatequestion.php" class="admin"><b>Update/Delete Question</b></a><br/></li>
<li><a href="updateanswer.php" class="admin"><b>Delete Answers</b></a><br/></li>
<li><a href="users.php" class="admin"><b>List Of Users</b></a><br/></li>
<li><a href="userdetails.php" class="admin"><b>User Details</b></a><br/></li>
<li><a href="viewmessage.php" class="admin"><b>View Messages</b></a><br/></li>
<li><a href="viewfeedback.php" class="admin"><b>View Feedbacks</b></a><br/></li>
<li><a href="addadmin.php" class="admin"><b>Add Admin</b></a><br/></li>
