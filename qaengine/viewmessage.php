...
<span itemprop="name"><h2><a href="viewmessage.php">Messages</a></h2></span></div>
...
header("location:error.php");
	...
	$q="select * from contactus order by msgdate desc";
	$res=mysqli_query($conn,$q) or die("Error in query " . mysqli_error($conn));
	$cnt=mysqli_affected_rows($conn);
	if($cnt==0)
	{
		print "<h2>No Message available</h2>";
	}
	else
	{
...
<h4 itemprop='name'>
<font color='#000000'>From :</font> $x[Email]
</h4>
Name  : $x[0]   &nbsp;&nbsp;&nbsp;Phone : $x[1]
...
Added on $sdate </span>
<span class='mask-poll'><a href='deletemessage.php?date=$x[4]'>Delete</a></span>
